...
<head>
    ...
    <title>Update Pengumuman - Learnify</title>
    <!-- General CSS Files -->
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu">
                                <li><a class="nav-link" href="<?= base_url('admin/pengumuman') ?>">Daftar Artikel</a>
                                </li>
                                <li><a class="nav-link" href="<?= base_url('admin/tambah_pengumuman') ?>">Posting Artikel</a>
                                </li>
                            </ul>
                        </li>
                ...
                <section class="section">
                    <div class="">
                        <div class="card" style="width:100%;">
                            <div class="card-body">
                                <h2 class="card-title" style="color: black;">Tambah Pengumuman bagi Siswa & Guru</h2>
                                <hr>
                    ...
                    <div id="detail" class="card card-success">
                        ...
                        <div class="card-body">
                            <form method="POST" action="<?= base_url('admin/update_pengumuman/'.$pengumuman[0]->id) ?>">
                                <div class="form-group">
                                    <label for="judul">Judul</label>
                                    <input id="judul" type="text" class="form-control" name="judul" value="<?= $pengumuman[0]->judul ?>">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea id="deskripsi" type="text" class="form-control" name="deskripsi"><?= $pengumuman[0]->deskripsi ?></textarea>
